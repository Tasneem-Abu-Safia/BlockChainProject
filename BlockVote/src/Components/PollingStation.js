...
import LoadingPhoto from "../assets/LoadingPhoto.png";

const PollingStation = (props) => {
    const [candidate1URL, changeCandidate1Url] = useState(LoadingPhoto);
    const [candidate2URL, changeCandidate2Url] = useState(LoadingPhoto);
